...
export default class WalletService {
     ...
     * @returns {WalletAddressResponseDTO} WalletAddressResponseDTO response from circle api
     */
    async getWalletAddresses(id: string, wallet: WalletAddressRequestDTO): Promise<ApiResponse<WalletAddressResponseDTO>> {
        try {
            let result = await this.dataService.getWalletAddresses(id, wallet)
            return result
        } catch (e: any) {
            return e
        }
